...
import { verticalMenuItems_member } from './menu';
import { horizontalMenuItems_member } from './menu';
import { horizontalMenuItems_Admin } from './menu';
import { horizontalMenuItems_Operator } from './menu';
import { horizontalMenuItems_Agency } from './menu';
import { verticalMenuItems_guest } from './menu';
import { horizontalMenuItems_guest } from './menu';
...
export class MenuService {
  ...
  public getVerticalMenuItems():Array<Menu> {
    ...
    if(user==null)
      return verticalMenuItems_guest;
    else if(user.role=='user')
      return verticalMenuItems_member;
  }

  public getHorizontalMenuItems():Array<Menu> {
    let user = this.cacheService.getUser();
    if(user==null)
      return horizontalMenuItems_guest;
    else if(user.role=='user')
      return horizontalMenuItems_member;
    else if(user.role=='agency')
      return horizontalMenuItems_Agency;
    else if(user.role=='operator')
      return horizontalMenuItems_Operator;
    else if(user.role=='admin')
      return horizontalMenuItems_Admin;
  }
